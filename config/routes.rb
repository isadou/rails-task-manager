Rails.application.routes.draw do
  ...
  # la ligne de commande ci-dessous remplace toutes les routes déclarées
  # ci-dessus et dont les éléments seront récupérées
  # à partir du controller grâce à rails
  resources :tasks
end
